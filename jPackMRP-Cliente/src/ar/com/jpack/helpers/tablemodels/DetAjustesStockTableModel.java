 ...
 * @author jmhanun
 */
public class DetAjustesStockTableModel extends CustomTableModel {
    ...
    public DetAjustesStockTableModel(String[] columnNames, List datos) {
        super(columnNames, datos);
    }

    @Override
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        DetAjustesStockT record = (DetAjustesStockT) dataVector.get(rowIndex);
        switch (columnIndex) {
            case 3:
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case ID_INDEX:
                if (record.getDetajustesstockPK() != null) {
                    return String.valueOf(record.getDetajustesstockPK().getIdDetAjustesStock());
                } else {
                    return "";
                }
            case CODIGO_INDEX:
