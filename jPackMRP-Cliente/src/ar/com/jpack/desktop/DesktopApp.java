...
import ar.com.jpack.negocio.OrdenescompraFacadeRemote;
...
//                    return false;
    ...
    public Integer insertFacturaT(Integer idRemito) {
        try {
            remitosFacade = (RemitosFacadeRemote) lookUp("ar.com.jpack.negocio.RemitosFacadeRemote");
            return remitosFacade.insertFacturaT(idRemito);
        } catch (NamingException ex) {
            JOptionPane.showMessageDialog(null, "Ha ocurrido un NamingException. Consulte al administrador.");
            Logger.getLogger(DesktopApp.class.getName()).log(Level.SEVERE, null, ex);
            return null;
    ...
    public MaquinasT updateMaquinasT(MaquinasT dto) {
        try {
            maquinasFacade = (MaquinasFacadeRemote) lookUp("ar.com.jpack.negocio.MaquinasFacadeRemote");
            return maquinasFacade.updateMaquinasT(dto);
        } catch (NamingException ex) {
            JOptionPane.showMessageDialog(null, "Ha ocurrido un NamingException. Consulte al administrador.");
            Logger.getLogger(DesktopApp.class.getName()).log(Level.SEVERE, null, ex);
            return null;
    ...
    public PreciosT updatePreciosT(PreciosT dto) {
        try {
            preciosFacade = (PreciosFacadeRemote) lookUp("ar.com.jpack.negocio.PreciosFacadeRemote");
            return preciosFacade.updatePreciosT(dto);
        } catch (NamingException ex) {
            JOptionPane.showMessageDialog(null, "Ha ocurrido un NamingException. Consulte al administrador.");
            Logger.getLogger(DesktopApp.class.getName()).log(Level.SEVERE, null, ex);
            return null;
...
//                `splistaprecios`(paumento DOUBLE, pidusuario INTEGER, plistaant INTEGER, out vidlista integer)
        try {
            listaspreciosFacade = (ListaspreciosFacadeRemote) lookUp("ar.com.jpack.negocio.ListaspreciosFacadeRemote");
            listaspreciosFacade.insertarListasPreciosT(porcentaje, usuarioLogueado);
        } catch (NamingException ex) {
            JOptionPane.showMessageDialog(null, "Ha ocurrido un NamingException. Consulte al administrador.");
            Logger.getLogger(DesktopApp.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public Boolean validarComponentes(List<ComponentesT> listDto) {
        try {
            articulosFacade = (ArticulosFacadeRemote) lookUp("ar.com.jpack.negocio.ArticulosFacadeRemote");
            return articulosFacade.validarComponentes(listDto);
        } catch (NamingException ex) {
            JOptionPane.showMessageDialog(null, "Ha ocurrido un NamingException. Consulte al administrador.");
            Logger.getLogger(DesktopApp.class.getName()).log(Level.SEVERE, null, ex);
            return null;
    ...
    public ProvinciasT updateProvinciasT(ProvinciasT dto) {
        try {
            domiciliosFacade = (DomiciliosFacadeRemote) lookUp("ar.com.jpack.negocio.DomiciliosFacadeRemote");
            return domiciliosFacade.updateProvinciasT(dto);
        } catch (NamingException ex) {
            JOptionPane.showMessageDialog(null, "Ha ocurrido un NamingException. Consulte al administrador.");
            Logger.getLogger(DesktopApp.class.getName()).log(Level.SEVERE, null, ex);
            return null;
    ...
    public OrdenesCompraT updateOrdenCompraT(OrdenesCompraT orden, ArrayList<DetalleOrdenesComprasT> listDto) {
        try {
            ordenesCompraFacade = (OrdenescompraFacadeRemote) lookUp("ar.com.jpack.negocio.OrdenescompraFacadeRemote");
            return ordenesCompraFacade.updateOrdenCompraT(orden, listDto);
        } catch (NamingException ex) {
            JOptionPane.showMessageDialog(null, "Ha ocurrido un NamingException. Consulte al administrador.");
            Logger.getLogger(DesktopApp.class.getName()).log(Level.SEVERE, null, ex);
            return null;
    ...
    public AjustesStockT updateAjustesStockT(AjustesStockT ajuste, ArrayList<DetAjustesStockT> listaDetAjustesStockT) {
        try {
            ordenesproduccionFacade = (OrdenesproduccionFacadeRemote) lookUp("ar.com.jpack.negocio.OrdenesproduccionFacadeRemote");
            return ordenesproduccionFacade.updateAjustesStockT(ajuste, listaDetAjustesStockT);
        } catch (NamingException ex) {
            JOptionPane.showMessageDialog(null, "Ha ocurrido un NamingException. Consulte al administrador.");
            Logger.getLogger(DesktopApp.class.getName()).log(Level.SEVERE, null, ex);
            return null;
    ...
    public FeriadosT updateFeriadosT(FeriadosT dto) {
        try {
            feriadosFacade = (FeriadosFacadeRemote) lookUp("ar.com.jpack.negocio.FeriadosFacadeRemote");
            return feriadosFacade.updateFeriadosT(dto);
        } catch (NamingException ex) {
            JOptionPane.showMessageDialog(null, "Ha ocurrido un NamingException. Consulte al administrador.");
            Logger.getLogger(DesktopApp.class.getName()).log(Level.SEVERE, null, ex);
            return null;
    ...
    public SetupT updateSetupT(SetupT dto) {
        try {
            setupFacade = (SetupFacadeRemote) lookUp("ar.com.jpack.negocio.SetupFacadeRemote");
            return setupFacade.updateSetupT(dto);
        } catch (NamingException ex) {
            JOptionPane.showMessageDialog(null, "Ha ocurrido un NamingException. Consulte al administrador.");
            Logger.getLogger(DesktopApp.class.getName()).log(Level.SEVERE, null, ex);
            return null;
