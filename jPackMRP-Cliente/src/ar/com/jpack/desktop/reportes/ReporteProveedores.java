...
public class ReporteProveedores extends CustomInternalFrame {
    ...
    private class ShowReporteTask extends org.jdesktop.application.Task<Object, Void> {
        ShowReporteTask(org.jdesktop.application.Application app) {
            // Runs on the EDT.  Copy GUI state that
            // doInBackground() depends on from parameters
            // to ShowReporteTask fields, here.
            super(app);
        }
    ...
    class Reporte extends Task<String, Void> {
        ...
        protected String doInBackground() throws Exception {
            ...
            if (!txtProveedor.getText().isEmpty()) {
                parametro.put("pproveedor", Integer.parseInt(txtProveedor.getText()));
            }
