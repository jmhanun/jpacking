...
/*
 * ReporteOrdenesDeposito.java
 *
 * Created on 13-sep-2009, 17:45:11
 */
 ...
 * @author Pablo
 */
public class ReporteOrdenesDeposito extends CustomInternalFrame {

    /** Creates new form ReporteOrdenesDeposito */
    public ReporteOrdenesDeposito() {
        initComponents();
    ...
    class Reporte extends Task<String, Void> {
        ...
        protected String doInBackground() throws Exception {
            ...
            if (!txtOrdenDeposito.getText().isEmpty()) {
                parametro.put("pordendeposito", new Integer(txtOrdenDeposito.getText()));
            }
            ...
            JasperPrint jp = DesktopApp.getApplication().getReporte("ordenesdeposito", parametro);
            JasperViewer jv = new JasperViewer(jp, false);
            jv.setTitle("Reporte de Ordenes de Deposito");
            jv.setVisible(true);
    ...
    public void cancelar() {
        try {
            ...
            Logger.getLogger(ReporteOrdenesDeposito.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        txtOrdenDeposito = new javax.swing.JTextField();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ar.com.jpack.desktop.DesktopApp.class).getContext().getResourceMap(ReporteOrdenesDeposito.class);
        ...
        txtOrdenDeposito.setText(resourceMap.getString("txtOrdenDeposito.text")); // NOI18N
        txtOrdenDeposito.setName("txtOrdenDeposito"); // NOI18N

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ar.com.jpack.desktop.DesktopApp.class).getContext().getActionMap(ReporteOrdenesDeposito.class, this);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtOrdenDeposito, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE))
                        .addContainerGap())
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtOrdenDeposito, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cancelarButton)
                    .addComponent(aceptarButton))
    ...
    private javax.swing.JTextField txtOrdenDeposito;
