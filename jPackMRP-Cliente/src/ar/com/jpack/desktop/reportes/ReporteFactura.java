 ...
 * ReporteFactura.java
 *
 * Created on 12-sep-2009, 19:30:16
 */
 ...
 * @author Pablo
 */
public class ReporteFactura extends CustomInternalFrame {
    ...
    class Reporte extends Task<String, Void> {
        ...
        protected String doInBackground() throws Exception {
            ...
            if (!txtFactura.getText().isEmpty()) {
                parametro.put("pfactura", new Integer(txtFactura.getText()));
            }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ar.com.jpack.desktop.DesktopApp.class).getContext().getResourceMap(ReporteFactura.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ar.com.jpack.desktop.DesktopApp.class).getContext().getActionMap(ReporteFactura.class, this);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtFactura, javax.swing.GroupLayout.DEFAULT_SIZE, 333, Short.MAX_VALUE))
