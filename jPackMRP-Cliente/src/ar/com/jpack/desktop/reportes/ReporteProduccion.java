...
public class ReporteProduccion extends CustomInternalFrame {
    ...
    class Reporte extends Task<String, Void> {
        ...
        protected String doInBackground() throws Exception {
            ...
            if (!jTextField1.getText().isEmpty()) {
                parametro.put("pmaquina", new Integer(jTextField1.getText()));
            }
    ...
    @Action
    public void ayuda() {
        JOptionPane.showInternalMessageDialog(this, "Usa Fecha de Inicio Real");
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(ayudaButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGap(141, 141, 141)
