...
public class DataTransferHelper {
    ...
    public static ArticulosT copiarArticulo(Articulos item) {
        ArticulosT t = null;
//        System.out.println("*comp" + item.getIdArticulo() + "-------------------------------------------------" + item.getComponentesCollection().size());
//        System.out.println("*arti" + item.getIdArticulo() + "-------------------------------------------------" + item.getArticulosCollection().size());
//        System.out.println(item.getArticulosCollection().toString());
//        Iterator i = item.getArticulosCollection().iterator();
//        
//        while (i.hasNext()) {
//            System.out.println("***");
//            System.out.println(((Componentes)i.next()).getArticulos().getDescripcion());
//            System.out.println("***");
//        }
//        
        if (item != null) {
